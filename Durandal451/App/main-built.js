...
requirejs.config({paths:{text:"../Scripts/text",durandal:"../Scripts/durandal",plugins:"../Scripts/durandal/plugins",transitions:"../Scripts/durandal/transitions",knockout:"../Scripts/knockout-2.3.0","knockout.validation":"../Scripts/knockout.validation",bootstrap:"../Scripts/bootstrap",jquery:"../Scripts/jquery-1.10.2","jquery.utilities":"../Scripts/jquery.utilities",toastr:"../Scripts/toastr"},shim:{bootstrap:{deps:["jquery"],exports:"jQuery"},"knockout.validation":{deps:["knockout"]},"jquery.utilities":{dep:["jquery"]}}}),define('main',["durandal/system","durandal/app","durandal/viewLocator","global/session","knockout","knockout.validation"],function(e,t,n,r,i){function o(){i.validation.init({insertMessages:!0,decorateElement:!0,errorElementClass:"has-error",errorMessageClass:"help-block"}),i.utils.cloneNodes||(i.utils.cloneNodes=function(e,t){for(var n=0,r=e.length,o=[];r>n;n++){var a=e[n].cloneNode(!0);o.push(t?i.cleanNode(a):a)}return o}),i.bindingHandlers.ifIsInRole={init:function(e){return i.utils.domData.set(e,"__ko_withIfBindingData",{}),{controlsDescendantBindings:!0}},update:function(e,t,n,o,a){var s=i.utils.domData.get(e,"__ko_withIfBindingData"),l=i.utils.unwrapObservable(t()),u=r.userIsInRole(l),c=!s.savedNodes,d=c||u!==s.didDisplayOnLastUpdate,f=!1;d&&(c&&(s.savedNodes=i.utils.cloneNodes(i.virtualElements.childNodes(e),!0)),u?(c||i.virtualElements.setDomNodeChildren(e,i.utils.cloneNodes(s.savedNodes)),i.applyBindingsToDescendants(f?f(a,l):a,e)):i.virtualElements.emptyNode(e),s.didDisplayOnLastUpdate=u)}}}e.debug(!0),t.title="Durandal 451",t.configurePlugins({router:!0,dialog:!0,widget:!0}),o(),t.start().then(function(){n.useConvention(),t.setRoot("viewmodels/shell","entrance")})});
/*
 * Toastr
 * Version 2.0.1
...
define('viewmodels/login',["plugins/router","durandal/app","services/security","global/session","services/logger","jquery","knockout","knockout.validation"],function(e,t,n,r,o,i,a){function s(e){var t=this;t.name=a.observable(e.name),t.login=function(){sessionStorage.state=e.state,sessionStorage.loginUrl=e.url,sessionStorage.externalLogin=!0,r.archiveSessionStorageToLocalStorage(),window.location=e.url}}function l(){var e=i.Deferred();return r.isBusy(!0),f.loaded?(r.isBusy(!1),e.resolve()):(n.getExternalLogins(n.returnUrl,!0).done(function(e){if("object"==typeof e){for(var t=0;t<e.length;t++)f.externalLoginProviders.push(new s(e[t]));f.loaded=!0}else o.log({message:"Error loading external authentication providers.",data:"",showToast:!0,type:"warning"}),f.loaded=!1}).fail(function(){o.log({message:"Error loading external authentication providers.",data:"",showToast:!0,type:"warning"}),f.loaded=!1}).always(function(){return r.isBusy(!1),e.resolve()}),e.promise())}function u(){e.navigateBack()}function c(){return f.validationErrors().length>0?(f.validationErrors.showAllMessages(),void 0):(r.isBusy(!0),n.login({grant_type:"password",username:f.userName(),password:f.password()}).done(function(t){t.userName&&t.access_token?(r.setUser(t,f.rememberMe()),e.navigate("#/","replace")):o.log({message:"Error logging in.",data:"",showToast:!0,type:"error"})}).always(function(){f.userName(""),f.password(""),r.isBusy(!1)}).failJSON(function(e){e&&e.error_description?o.log({message:"Error logging in.",data:e.error_description,showToast:!0,type:"error"}):o.log({message:"Error logging in.",data:"",showToast:!0,type:"error"})}),void 0)}function d(){e.navigate("#/register","replace")}var f={activate:l,goBack:u,title:"login",session:r,validationTriggered:a.observable(!1),userName:a.observable("").extend({required:!0}),password:a.observable("").extend({required:!0}),rememberMe:a.observable(!1),externalLoginProviders:a.observableArray(),loaded:!1,login:c,register:d};return f.validationErrors=a.validation.group([f.userName,f.password]),f.hasExternalLogin=a.computed(function(){return f.externalLoginProviders().length>0}),f});
...
define('viewmodels/welcome',[],function(){var e={displayName:"Durandal 451",description:"Durandal is a cross-device, cross-platform client framework written in JavaScript and designed to make Single Page Applications (SPAs) easy to create and maintain. This project template is based on the ASP.NET 4.5.1 Single Page Application template.",features:["OWIN OAuth support (with 3rd party authentication providers","Remember user using local storage","Configure routing by what role(s) a user should be in in order to navigate to a view","Customise view for the user dependent on what roles they are in"]};return e});
